...
kernel: bootstrap.o link.ld kernel.o sys.o vga.o gdt.o
	i686-elf-gcc -T link.ld -o PulsarOS.bin -ffreestanding -O2 -nostdlib bootstrap.o kernel.o sys.o vga.o gdt.o -lgcc
